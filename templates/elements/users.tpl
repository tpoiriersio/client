        ...
        <div class="col-md-6">
            <div class="card placementPublication relation-card">
                ...
                <div class="card-body">
                    ...
                    <a href="" title="Se mettre en relation" class="bouton-relation">
                    ...
                    <a href="" title="Retirer des relations" class="bouton-relation">
                    ...
                    <!-- Options admin / modo -->
                    <a href="admin-edit-user.php" title="Modifier l'utilisateur" class="bouton-relation">
